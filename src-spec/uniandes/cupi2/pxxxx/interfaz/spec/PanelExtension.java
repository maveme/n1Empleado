...
public class PanelExtension extends _PanelExtension{
	...
	@UIBoton(comando="OPCION_1", label = "Opción 1", metodo = I.InterfazEmpleado
	.Method.reqFuncOpcion1)
	private JButton btnOpcion1;
	
	@UIBoton(comando="OPCION_2", label = "Opción 2", metodo = I.InterfazEmpleado
	.Method.reqFuncOpcion2)
